...
<div id="edit-poType" class="content scaffold-edit" role="main">
  ...
  <g:hasErrors bean="${poTypeInstance}">
    <div id="form-error" class="alert alert-danger" role="alert">
      <g:eachError bean="${poTypeInstance}" var="error">
  ...
  <g:form url="[resource: poTypeInstance, action: 'update']" method="PUT"  class="form-horizontal">
  <g:hiddenField name="version" value="${poTypeInstance?.version}"/>
  <fieldset class="form">
