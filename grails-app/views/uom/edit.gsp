...
<div id="edit-uom" class="content scaffold-edit" role="main">
  ...
  <g:hasErrors bean="${uomInstance}">
    <div id="form-error" class="alert alert-danger" role="alert">
      <g:eachError bean="${uomInstance}" var="error">
  ...
  <g:form url="[resource: uomInstance, action: 'update']" method="PUT"  class="form-horizontal">
  <g:hiddenField name="version" value="${uomInstance?.version}"/>
  <fieldset class="form">
