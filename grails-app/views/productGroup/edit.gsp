...
<div id="edit-productGroup" class="content scaffold-edit" role="main">
  ...
  <g:hasErrors bean="${productGroupInstance}">
    <div id="form-error" class="alert alert-danger" role="alert">
      <g:eachError bean="${productGroupInstance}" var="error">
  ...
  <g:form url="[resource: productGroupInstance, action: 'update']" method="PUT"  class="form-horizontal">
