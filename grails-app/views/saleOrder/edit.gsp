...
<div id="edit-saleOrder" class="content scaffold-edit" role="main">
  ...
  <g:form url="[resource: saleOrderInstance, action: 'update']" method="PUT"  class="form-horizontal">
  <g:hiddenField name="version" value="${saleOrderInstance?.version}"/>
  <fieldset class="form">
    <g:render template="form"/>
  </fieldset>
  <g:actionSubmit class="btn btn-primary" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" onclick="return validate()"/>
  </g:form>
</div>
</body>
</html>
